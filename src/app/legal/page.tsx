      ...
      <main className="container mx-auto flex-1 px-4 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <section className="mb-12">
            ...
            <div className="prose dark:prose-invert text-muted-foreground max-w-none space-y-4">
              <p>By using Time to Just, you agree to these terms. Please read them carefully.</p>
              <h3 className="text-foreground text-lg font-medium">1. Service Description</h3>
              <p>
              ...
              <h3 className="text-foreground text-lg font-medium">2. User Responsibilities</h3>
              <p>
              ...
              <h3 className="text-foreground text-lg font-medium">3. Service Availability</h3>
              <p>
                We strive to maintain high availability but do not guarantee uninterrupted service.
                We may modify or discontinue features with reasonable notice.
              </p>
              <h3 className="text-foreground text-lg font-medium">4. Limitation of Liability</h3>
              <p>
          ...
          <section className="mb-12">
            ...
            <div className="prose dark:prose-invert text-muted-foreground max-w-none space-y-4">
              <h3 className="text-foreground text-lg font-medium">Data We Collect</h3>
              <p>
              ...
              <h3 className="text-foreground text-lg font-medium">How We Use Your Data</h3>
              <p>Your email data is used exclusively to:</p>
              ...
              <h3 className="text-foreground text-lg font-medium">Data Security</h3>
              <p>
              ...
              <h3 className="text-foreground text-lg font-medium">Data Sharing</h3>
              <p>
              ...
              <h3 className="text-foreground text-lg font-medium">Your Rights</h3>
              <p>
